...
const Home = () => {
  ...
  return (
    <div className="container">
        ...
        <ul className="list-group">
          {list.map((item, key) => (
            <li className="list-group-item" id='item' key={key}>
              {item.label}
              {list.length > 1 && (
                <svg onClick={() => {cancelar(key)}} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-x" id="icon" viewBox="0 0 16 16">
      ...
      <button onClick={()=>{limpiar()}} type="button" className="btn btn-danger">
